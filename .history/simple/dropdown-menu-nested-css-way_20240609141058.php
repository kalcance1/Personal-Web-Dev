...
<div id="nested1" class="nested-content">
    <a href="#" onclick="showNested(event, 'nested3')">Nested Link 1.1</a>
    <a href="#" onclick="showNested(event, 'nested4')">Nested Link 1.2</a>
    <a href="#">Nested Link 1.3</a>
</div>

<div id="nested2" class="nested-content">
    <a href="#" onclick="showNested(event, 'nested5')">Nested Link 2.1</a>
    <a href="#" onclick="showNested(event, 'nested6')">Nested Link 2.2</a>
    <a href="#">Nested Link 2.3</a>
</div>

<div id="nested3" class="nested-content">
    <button class="back-btn" onclick="goBack(event)">Back</button>
    <a href="#">Nested Link 1.1.1</a>
    <a href="#">Nested Link 1.1.2</a>
</div>

<div id="nested4" class="nested-content">
    <button class="back-btn" onclick="goBack(event)">Back</button>
    <a href="#">Nested Link 1.2.1</a>
    <a href="#">Nested Link 1.2.2</a>
</div>

<div id="nested5" class="nested-content">
    <button class="back-btn" onclick="goBack(event)">Back</button>
    <a href="#">Nested Link 2.1.1</a>
    <a href="#">Nested Link 2.1.2</a>
</div>

<div id="nested6" class="nested-content">
    <button class="back-btn" onclick="goBack(event)">Back</button>
    <a href="#">Nested Link 2.2.1</a>
    <a href="#">Nested Link 2.2.2</a>
</div>
<!-- Nested Content End -->
...
<script>
    ...
    function showNested(event, id) {
        ...
        // Determineif the selected content is within a dropdown

...
<script>
    ...
    var parentDropdowns = nestedContent.closest('.dropdown-content').querySelectorAll('.dropdown-content, .nested-content');
    navigationStack = Array.from(parentDropdowns).reverse(); // Update stack with parent dropdowns

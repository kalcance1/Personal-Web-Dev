...
<div class="dropdown">
    ...
    <div id="dropdown1" class="dropdown-content">
        ...
        <!-- Nested Content End for nested3 -->
    </div>
</div>
<!-- Dropdown End -->

<!-- Nested Content Start for dropdown2 -->
<div class="dropdown">
    <div id="dropdown2" class="dropdown-content">
        ...
        <!-- Nested Content End for dropdown2 -->
    </div>
</div>
<!-- Dropdown End -->

<!-- Nested Content Start for nested4 -->
<div class="dropdown">
    <div id="dropdown4" class="dropdown-content">
        ...
        <!-- Nested Content End for nested4 -->
    </div>
</div>
<!-- Dropdown End -->
...
<script>
    ...
    if (previousDropdown) {
        ...
        // Check if the previous dropdown has a parent dropdown
        var parentDropdown = previousDropdown.closest('.dropdown-content');
        if (parentDropdown) {
            console.log("Parent dropdown found:", parentDropdown.id);
            // Check if the parent dropdown is already shown
            if (!parentDropdown.classList.contains("show")) {
                // If not, proceed to show the parent dropdown
                proceedAfterAnimation();
            } else {
                // If yes, show the previous dropdown after animation
                setTimeout(function() {
                    console.log("Showing previous dropdown:", previousDropdown.id);

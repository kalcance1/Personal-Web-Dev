...
<script>
    ...
    function showNested(event, id) {
        ...
        hideAllNested(); // Hide all currently shown nested contents
        ...
        var parent = nestedContent.closest('.dropdown-content, .nested-content');
        if (parent) {
    ...
    function goBack(event) {
        ...
        if (currentContent) {
            ...
            navigationStack.pop(); // Remove current content from stack
    ...
    function hideAllNested() {
        var nestedContents = document.querySelectorAll('.nested-content');

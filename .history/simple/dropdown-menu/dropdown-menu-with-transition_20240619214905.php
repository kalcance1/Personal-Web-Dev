...
<script>
    ...
    function showNested(event, id) {
        ...
        // Find the parent dropdown or nested content
        var parent = findParentDropdown(event.target);
        console.log('Parent dropdown:', parent); // Debug statement

        // If there is a parent dropdown or nested content, push it into the navigation stack
        if (parent) {
    ...
    function findParentDropdown(element) {
        // Find the closest parent with class 'dropdown-content' or 'nested-content'
        while (element) {
            if (element.classList.contains('dropdown-content') || element.classList.contains('nested-content')) {
                return element;
            }
            element = element.parentElement;
        }
        return null; // No parent dropdown found
    }
